# Uncomment the one line that describes your filing status this year.
status = "single"
...
# Should I print out fields that you left at zero and can be left blank when filling in your forms?
